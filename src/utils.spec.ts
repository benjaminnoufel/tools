...
describe("test utils function", (): void => {
    ...
    describe("test getEnvsOrThrow function", (): void => {
        ...
        it("should be throw env is undefined", (): void => {
            ...
            expect(() => getEnvsOrThrow(["TEST"], false)).toThrow(new ReferenceError("Please, set the TEST variable in the .env file."));
        });
        ...
        it("should be return all environment", () => {
            ...
            const [NODE_ENV, TEST] = getEnvsOrThrow(["NODE_ENV", "TEST"], false);
